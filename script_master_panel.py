...
# -*- coding: utf-8 -*-
"""
Created on Wed Mar  4 01:18:54 2026
...
# -*- coding: utf-8 -*-
"""
PANEL MASTER — STEP 13 (ZORI fija la muestra) + HOAM + Affordability_Zori
+ MPS_ORTH + EFFR + FEDFUNDS + MORTGAGE30US + PCEPILFE

MODIFICACIONES PEDIDAS:
1) Renombrar "Permits" -> "Building_permits".
2) Restringir TODO el panel a años 2015–2023 (dropear 2024, 2025, 2026).
3) Código claro con notas por STEP.
4) OUTPUT final: panel_master_rents.csv

OUTPUT:
- /Users/vegagonzalez/Desktop/rents/panel_master_rents.csv
"""
...
# OUTPUT final pedido
OUT_PATH = os.path.join(BASE_DIR, "panel_master_rents.csv")

# Ventana final pedida del panel
PANEL_YEAR_MIN = 2015
PANEL_YEAR_MAX = 2023
...
# ============================================================
# STEP 2 — ZORI: fija muestra + calendario mensual (INNER) y FILTRA 2015–2023
# ============================================================
print("\n==============================")
print("STEP 2: ZORI fija la muestra (INNER, 2015+) + filtro panel 2015–2023")
print("==============================")
...
# >>> FILTRO PEDIDO: mantener SOLO 2015–2023
panel = panel[
    pd.to_numeric(panel["year"], errors="coerce").between(PANEL_YEAR_MIN, PANEL_YEAR_MAX)
].copy()

print("Panel tras ZORI inner + filtro 2015–2023 (filas):", len(panel))
print("CBSACodes en panel:", panel["CBSACode"].nunique())
print("Rango años en panel:", panel["year"].min(), "->", panel["year"].max())
...
# ============================================================
# STEP 9–13 — Macros mensuales (LEFT por year,month) ya en 2015–2023
# ============================================================
print("\n==============================")
...
# Guard rail final: seguimos en 2015–2023 y misma cantidad de filas
print("\n==============================")
print("CHECK FINAL")
print("==============================")
print("Filas finales:", len(panel), "| Filas tras ZORI:", N_AFTER_ZORI)
print("Rango años final:", panel["year"].min(), "->", panel["year"].max())
