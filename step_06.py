...
# Parseo robusto de Month mensual (YYYY-MM), incluyendo casos de fecha completa o serial de Excel
month_dt = pd.to_datetime(hoam["Month"], errors="coerce")
month_num = pd.to_numeric(hoam["Month"], errors="coerce")
...
hoam["year"] = month_dt.dt.year.astype("Int64").astype("string")
hoam["month"] = month_dt.dt.month.astype("Int64").astype("string").str.zfill(2)
